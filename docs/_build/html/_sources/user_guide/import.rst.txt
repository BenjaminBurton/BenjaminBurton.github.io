...
.. code-block:: python
    ...
    var2 = "386"
        ...
        # Another string variable that looks like a number
    
    print(type(var2))

        # Printing the type of var2, which is also a string `<class 'str'>`

    var3 = int(var2)

        # Converting the string '386' to an integer

    print(type(var3))

        # Printing the type of var3, which will now be `<class 'int'>`

    var4 = input("Enter a number: ")

        # Taking user input, which will always return a string
    ...
    print(type(var4))
        ...
        # Printing the type of var4, which will be `<class 'str'>`

    var5 = float(var4)

        # Converting the user input (string) to a float

    print(var5 + 1)

        # Adding 1 to the float value and printing the result
    ...
    print(type(var6))
        ...
        # Printing the type of var6, which will be `<class 'datetime.datetime'>`
...
.. code-block:: python
    ...
    print(f"Type of result: {type(result)}")
        ...
        # Type will be float since var2 is float
...
.. code-block:: python
    ...
    message = "Data Science is fun!"
    print(f"Sliced message: {message[0:4]}")

        # Output: Data

    print(f"Reversed message: {message[::-1]}")

        # Output: !nuf si ecneicS ataD
...
.. code-block:: python
    ...
    print(f"2 raised to the power 5: {math.pow(2, 5)}")
...
.. code-block:: python
    ...
    float_num = 8.75
    print(f"Integer part of {float_num}: {int(float_num)}")

        # Output: 8


    print(f"Rounded value of {float_num}: {round(float_num)}")
...
.. code-block:: python
    ...
    print(f"Second item in list: {my_list[1]}")

        # Indexing

    print(f"Last item in list: {my_list[-1]}")
